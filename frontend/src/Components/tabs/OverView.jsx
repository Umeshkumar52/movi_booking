      ...
      <div className="max-w-4xl mx-auto py-6">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-300 text-lg leading-relaxed text-justify">
            {data?.storyline ||
              "No storyline content available for this movie yet."}
          </p>
        </div>
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-2">
                  {(typeof data?.genres === "string"
                    ...
                    <span
                      key={index}
                      className="px-4 py-1.5 bg-slate-800 border border-slate-700 text-slate-300 rounded-full text-sm font-medium shadow-sm"
                    >
                      {genre.trim()}
                    </span>
                  ))}
